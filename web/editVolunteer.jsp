...
<html>
    <head>
        ...
        <title>Edit Volunteer Status</title>
                    ...
                    <table id="example" border="2px solid #529432" >
                        ...
                        <c:forEach items="${VolunteerList}" var="volunteer">
                            <tr>
                                ...
                                <td >
                                    ${volunteer.getName()}                    </td>
                                
                                <td >
                                    ${volunteer.getAadharNumber()}                    </td>
                                
                                <td >
                                    ${volunteer.getPhoneNumber()}                    </td>
                                <td >
                                    ${volunteer.getMesssage()}                    </td>

                                <td>

                                    <c:if test="${volunteer.getStatus()==0}">
                                        <c:out value="${'PENDING'}"/> 
                                    </c:if>
                                    <c:if test="${volunteer.getStatus()==1}">
                                ...
                                <td>   <!-- <form action="Edit" method="Post">
                                    ...
                                    <a href=EditVolunteerStatus?emailAddress=${volunteer.getEmailAddress()}>
                                        Edit</a>                    
                                </td>
                            </tr>

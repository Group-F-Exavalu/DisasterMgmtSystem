...
                //alert(responseText);
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Funds</h1>
<!--                    <p class="mb-4">DataTables is a third party plugin that is used to generate the demo table below.
                  ...
                  <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Funds Data</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive tableFixHead"> <!<!--  id="dataTable" -->
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <c:if test='${MoneyList!=null}'>
                                            <c:forEach items='${MoneyList}' var="money">
                                        <tr>
                                            <td>${money.getEventId()} </td>
